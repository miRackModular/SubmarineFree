...
Model *modelNG106 = Model::create<NG_1<6>, NG106>("Submarine", "NG-106", "NG-106 NOT Gates", LOGIC_TAG, MULTIPLE_TAG);
Model *modelNG112 = Model::create<NG_1<12>, NG112>("Submarine", "NG-112", "NG-112 NOT Gates", LOGIC_TAG, MULTIPLE_TAG);
