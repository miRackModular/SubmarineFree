...
Model *modelFF206 = Model::create<FF_2<6>, FF206>("Submarine", "FF-206", "FF-206 Edge Triggered Flip-Flops", LOGIC_TAG, MULTIPLE_TAG);
Model *modelFF212 = Model::create<FF_2<12>, FF212>("Submarine", "FF-212", "FF-212 Edge Triggered Flip-Flops", LOGIC_TAG, MULTIPLE_TAG);
