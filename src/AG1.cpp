...
Model *modelAG104 = Model::create<AG_1<4>, AG104>("Submarine", "AG-104", "AG-104 AND Gates", LOGIC_TAG, MULTIPLE_TAG);
Model *modelAG106 = Model::create<AG_1<6>, AG106>("Submarine", "AG-106", "AG-106 AND Gates", LOGIC_TAG, MULTIPLE_TAG);
