...
Model *modelOG104 = Model::create<OG_1<4>, OG104>("Submarine", "OG-104", "OG-104 OR Gates", LOGIC_TAG, MULTIPLE_TAG);
Model *modelOG106 = Model::create<OG_1<6>, OG106>("Submarine", "OG-106", "OG-106 OR Gates", LOGIC_TAG, MULTIPLE_TAG);
