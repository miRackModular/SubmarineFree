...
Model *modelLD103 = Model::create<LD_1<3>, LD103>("Submarine", "LD-103", "LD-103 Schmitt Trigger Line Drivers", LOGIC_TAG, MULTIPLE_TAG);
Model *modelLD106 = Model::create<LD_1<6>, LD106>("Submarine", "LD-106", "LD-106 Schmitt Trigger Line Drivers", LOGIC_TAG, MULTIPLE_TAG);
