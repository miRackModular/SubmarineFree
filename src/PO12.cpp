...
Model *modelPO101 = Model::create<PO_101, PO101>("Submarine", "PO-101", "PO-101 Phased VCO", OSCILLATOR_TAG, MULTIPLE_TAG, DIGITAL_TAG);
Model *modelPO102 = Model::create<PO_101, PO102>("Submarine", "PO-102", "PO-102 Phased LFO", OSCILLATOR_TAG, MULTIPLE_TAG, DIGITAL_TAG);
Model *modelPO204 = Model::create<PO_204, PO204>("Submarine", "PO-204", "PO-204 Phase Modulation Engine", OSCILLATOR_TAG, QUAD_TAG, DIGITAL_TAG);
